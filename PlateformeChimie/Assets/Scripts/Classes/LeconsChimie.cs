...
public class LeconsChimie
{
    ...
    private static string Cours2Lecon1 = "Le volume d'un gaz est donc inversement proportionnel à sa pression." +
        "À température constante, si la pression externe exercée sur un gaz augmente, le volume de celui-ci diminue. Conséquemment, les particules de gaz deviennent plus rapprochées et se heurtent davantage. " +
        "Par conséquent, les collisions sont plus fréquentes, ce qui augmente la pression. À l'inverse, si le volume du contenant est augmenté, la fréquence des collisions est moindre et la pression du gaz devient donc plus faible.";
